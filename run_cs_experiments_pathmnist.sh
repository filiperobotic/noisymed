#!/bin/bash
# ═══════════════════════════════════════════════════════════════════════════
# Run Cost-Sensitive Loss experiments — PathMNIST
# ═══════════════════════════════════════════════════════════════════════════
#
...
#
# Usage:
#   bash run_cs_experiments_pathmnist.sh              # All methods
#   bash run_cs_experiments_pathmnist.sh baseline_cs  # Only Baseline+CS
#   bash run_cs_experiments_pathmnist.sh gmm_filter_cs
#   bash run_cs_experiments_pathmnist.sh coteaching_cs
#   bash run_cs_experiments_pathmnist.sh dividemix_cs
#   bash run_cs_experiments_pathmnist.sh unicon_cs
#   bash run_cs_experiments_pathmnist.sh disc_cs
#
# ═══════════════════════════════════════════════════════════════════════════
...
echo "═══════════════════════════════════════════════════════════════"
echo "  CS Loss Experiments — PathMNIST"
echo "  Filter: $FILTER"
...
echo ""
echo "═══════════════════════════════════════════════════════════════"
echo "  PathMNIST CS experiments completed! ($CURRENT total)"
